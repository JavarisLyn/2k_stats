...
REAL_NBA = {
    ...
    ("Clyde", "Drexler"): {
        "场均篮板": "6.1", "场均助攻": "6.1", "场均盖帽": "0.7", "场均失误": "2.8",
    ...
    ("Stephen", "Curry"): {
        "场均篮板": "4.7", "场均盖帽": "0.2", "投篮命中率": "47.3",
    },
    ("Kevin", "Love"): {
        "场均助攻": "2.5", "场均抢断": "0.9", "场均盖帽": "0.3",
        "场均失误": "2.0", "投篮命中率": "45.2",
    },
    ("DeMarcus", "Cousins"): {
        "场均助攻": "3.2", "场均抢断": "1.2", "场均失误": "3.3",
        "投篮命中率": "46.9",
    },
    ("John", "Wall"): {
        "场均篮板": "4.3", "场均盖帽": "0.3", "投篮命中率": "42.3",
    },
    ("Patrick", "Ewing"): {
        "场均助攻": "1.9", "场均抢断": "1.0", "场均失误": "2.7",
        "投篮命中率": "50.4", "出场总数": "1183",
    },
    ("Russell", "Westbrook"): {
        "场均篮板": "7.5", "场均盖帽": "0.3", "投篮命中率": "43.8",
    },
    ("Marc", "Gasol"): {
        "场均助攻": "3.3", "场均抢断": "0.8", "场均失误": "1.7",
        "投篮命中率": "48.3",
    },
    ("LaMarcus", "Aldridge"): {
        "场均助攻": "2.0", "场均抢断": "0.7", "场均失误": "1.8",
        "投篮命中率": "48.1",
    },
}
...
def main():
    ...
    parser.add_argument("--honor-top", type=int, default=60, help="荣誉榜 Top N（0=跳过）")
    parser.add_argument("--stats-top", type=int, default=60, help="数据榜 Top N（0=跳过）")
